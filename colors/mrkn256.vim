...
function! <SID>init_light_colormap()
  let l:cm = {}
  " common group               fg        bg        attr
  let l:cm['Normal'] =       [ '000000', 'ebebeb', 'none' ]
  let l:cm['ColorColumn'] =  [ '------', '------', '' ]
  let l:cm['Conceal'] =      [ '------', '------', '' ]
  let l:cm['Cursor'] =       [ '708090', 'f0e68c', '' ]
  let l:cm['CursorIM'] =     [ '------', '------', '' ]
  let l:cm['CursorColumn'] = [ '------', '333333', 'none' ]
  let l:cm['CursorLine'] =   [ '------', 'ffffff', 'underline' ]
  let l:cm['Directory'] =    [ '------', '------', '' ]
  let l:cm['DiffAdd'] =      [ '------', '------', '' ]
  let l:cm['DiffChange'] =   [ '------', '------', '' ]
  let l:cm['DiffDelete'] =   [ '------', '------', '' ]
  let l:cm['DiffText'] =     [ '------', '------', '' ]
  let l:cm['ErrMsg'] =       [ '------', '------', '' ]
  let l:cm['VertSplit'] =    [ '999999', '333333', 'none' ]
  let l:cm['Folded'] =       [ 'ff0000', 'bbbbbb', 'none' ]
  let l:cm['FoldColumn'] =   [ 'd2b48c', '4d4d4d', '' ]
  let l:cm['SignColumn'] =   [ '------', '------', '' ]
  let l:cm['IncSearch'] =    [ '708090', 'f0e68c', '' ]
  let l:cm['LineNr'] =       [ '666666', '------', 'none' ]
  ...
  let l:cm['SpellLocal'] =   [ '------', '------', '' ]
  let l:cm['SpellRare'] =    [ '------', '------', '' ]
  let l:cm['StatusLine'] =   [ 'ffd700', '000000', 'none' ]
  let l:cm['StatusLineNC'] = [ '000000', '666666', 'none' ]
  let l:cm['TabLine'] =      [ '------', '------', '' ]
  let l:cm['TabLineFill'] =  [ '------', '------', '' ]
  let l:cm['TabLineSel'] =   [ '------', '------', '' ]
  ...
  " common syntax                fg        bg        attr
  let l:cm['Comment'] =        [ '009933', '------', 'bold' ]
  let l:cm['Constant'] =       [ 'ffcc66', '------', '' ]
  let l:cm['String'] =         [ 'cc0000', '------', '' ]
  let l:cm['Character'] =      [ '------', '------', '' ]
  let l:cm['Number'] =         [ 'cc66ff', '------', '' ]
  let l:cm['Boolean'] =        [ '------', '------', '' ]
  let l:cm['Float'] =          [ '------', '------', '' ]
  ...
  let l:cm['SpecialChar'] =    [ '------', '------', '' ]
  let l:cm['Tag'] =            [ '------', '------', '' ]
  let l:cm['Delimiter'] =      [ 'cc0000', '------', 'bold' ]
  let l:cm['SpecialComment'] = [ '------', '------', '' ]
  let l:cm['Debug'] =          [ '------', '------', '' ]
  let l:cm['Underline'] =      [ '------', '------', '' ]
  let l:cm['Ignore'] =         [ '666666', '------', '' ]
